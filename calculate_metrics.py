...
if __name__ == "__main__":
	...
	parser.add_argument("-mark_myocardium", default = 1, help = "The marker of the myocardium in the segmentation.")
	parser.add_argument("-mark_scar", default = 3, help = "The marker of the scar in the segmentation.")
